...
const mm: Translations = {
  ...
  admin: {
    ...
    newPasswordPlaceholder: 'စကားဝှက်အသစ် ရိုက်ထည့်ပါ',
    newPasswordHint: 'လက်ရှိ စကားဝှက်ကို မပြောင်းလိုပါက ကျန်ထားပါ',
    role: 'ရာထူး',
    createBtn: 'အသုံးပြုသူ ဖန်တီးမည်',
    creating: 'ဖန်တီးနေပါသည်...',
    edit: 'ပြင်ဆင်မည်',
    editUserTitle: 'အသုံးပြုသူ ပြင်ဆင်မည်',
    editUserSuccess: 'အသုံးပြုသူ အောင်မြင်စွာ ပြင်ဆင်ပြီးပါပြီ',
    saving: 'သိမ်းဆည်းနေပါသည်...',
    saveBtn: 'ပြောင်းလဲမှုများ သိမ်းမည်',
    joined: 'ပါဝင်သည့်ရက်',
    sops: 'SOPs',
